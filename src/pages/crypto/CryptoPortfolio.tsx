...
export function CryptoPortfolio({ model }: { model: PortfolioModel }) {
  ...
  return <div className="page-stack">
    ...
    <Section title="Posições em cripto" subtitle="Custo médio móvel e cotação atual em dólares">
      ...
      {positions.length ? <div className="table-wrap table-wrap--crypto"><table className="portfolio-table portfolio-table--crypto"><thead><tr><th>Cripto</th><th>Quantidade</th><th>Preço médio</th><th>Cotação</th><th>Custo</th><th>Valor atual</th><th>Participação</th><th>Resultado aberto</th></tr></thead><tbody>
