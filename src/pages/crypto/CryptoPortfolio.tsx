  ...
  return <div className="page-stack">
    ...
    <Section title="Posições em cripto" subtitle="Custo médio móvel e cotação atual em dólares">
      <div className="toolbar">
        <label className="search-field"><Search size={17} /><input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Buscar Bitcoin ou Ethereum" /></label>
