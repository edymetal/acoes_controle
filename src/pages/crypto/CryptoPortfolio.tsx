...
export function CryptoPortfolio({ model }: { model: PortfolioModel }) {
  ...
  return <div className="page-stack">
    ...
    <section className="metrics-grid metrics-grid--three">
      ...
      <MetricCard label={valuationComplete ? "Valor de mercado" : "Valor conhecido (parcial)"} value={formatCurrency(model.metrics.marketValue)} icon={<BriefcaseBusiness size={19} />} helper={`${model.metrics.openPositions} criptos na carteira`} accent="violet" />
