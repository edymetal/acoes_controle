  ...
  return (
    <div className="page-stack">
      ...
      <section className="dashboard-grid dashboard-grid--lower">
        ...
        <Section title="Movimentações recentes" subtitle={`${transactions.length} registros de FIIs processados`} action={<button className="text-button" type="button" onClick={() => onNavigate("fii-history")}>Ver histórico <ArrowRight size={15} /></button>}>
