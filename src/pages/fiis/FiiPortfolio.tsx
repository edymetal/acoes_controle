...
export function FiiPortfolio({ model, usdRate }: { model: PortfolioModel; usdRate: number | null }) {
  ...
  return <div className="page-stack">
    ...
    <Section title="Posições em FIIs" subtitle="Custo médio móvel e cotação atual em reais">
      ...
      {positions.length ? <div className="table-wrap"><table className="portfolio-table"><thead><tr><th>Fundo</th><th>Cotas</th><th>Preço médio</th><th>Cotação</th><th>Custo</th><th>Valor atual</th><th>Participação</th><th>Resultado aberto</th></tr></thead><tbody>
